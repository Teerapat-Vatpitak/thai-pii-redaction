...
<div class="page">
  ...
  <div class="chips">
    ...
    <span class="chip">ทดสอบอัตโนมัติกว่า 300 กรณี</span>
  </div>
  ...
  <div class="grid2">
    <section>
      ...
      <p>ความเสี่ยงข้อมูลรั่วไปยัง AI ภายนอกลดลงเกือบทั้งหมดสำหรับ PII ที่ตรวจจับได้ เพราะตารางสลับค่าอยู่ในหน่วยความจำ ครอบคลุม PII มีรูปแบบ 10+ ประเภท + ชื่อ/ที่อยู่ + อ่อนไหว 8 หมวด ทดสอบครบวงจรบน Claude สำเร็จ ผ่านชุดทดสอบอัตโนมัติกว่า 300 กรณี (การวัด F1 ทางการเป็นงานขั้นต่อไป)</p>
    </section>
    <section>
...
<div class="page">
  ...
  <div class="foot">
    <div>ผล: ลดความเสี่ยงรั่ว ~100% สำหรับ PII ที่ตรวจจับได้ &nbsp;|&nbsp; ทดสอบจริงบน Claude &nbsp;|&nbsp; ทดสอบอัตโนมัติกว่า 300 กรณี</div>
