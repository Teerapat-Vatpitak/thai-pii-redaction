...
- [Standards mapping](standards-mapping.md) - how the implemented
  de-identification corresponds to ISO/IEC 20889 terminology and to มรด.
  6:2566 governance practices; a correspondence, not a conformance claim.
