...
| Exact-head branch CI | PASS — [11/11 jobs](https://github.com/Teerapat-Vatpitak/thai-pii-redaction/actions/runs/31177831416) on the reviewed code candidate and [11/11 jobs](https://github.com/Teerapat-Vatpitak/thai-pii-redaction/actions/runs/31178177864) on the final evidence branch head |
| Post-integration main CI and commit alignment | Outside this record; checked separately after the squash push |
