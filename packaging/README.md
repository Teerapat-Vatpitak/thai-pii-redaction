...
Current target: **v2.0.0**, Windows x64 NSIS installer
(`AI.Guard_2.0.0_x64-setup.exe`, SHA256 `e0831b9b5b22a2059239617e69de3005176c75d5503df173785bfee26e81c079`).
...
4. Fork [microsoft/winget-pkgs](https://github.com/microsoft/winget-pkgs), copy the three files to
   `manifests/t/Teerapat-Vatpitak/AIGuard/2.0.0/`, and open a PR. Or let wingetcreate do it:
