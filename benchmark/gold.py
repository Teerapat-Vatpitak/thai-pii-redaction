...
GOLD_DOCS: list[tuple[str, str, str]] = [
    ...
    (
        "nc04",
        "name_no_cue",
        "รายชื่อกรรมการ 1. [[NAME|อรทัย มีทรัพย์]] 2. [[NAME|ประเสริฐ ทองใบ]] 3. [[NAME|สุนิสา วงศ์ไทย]]",
    ),
    ...
    (
        "ad01",
        "address_varied",
        "จัดส่งพัสดุไปที่ [[ADDRESS|บ้านเลขที่ 45/12 หมู่ 3 ตำบลบางพระ อำเภอศรีราชา จังหวัดชลบุรี 20110]]",
    ),
    (
        "ad02",
        "address_varied",
        "ที่อยู่ตามบัตรประชาชน [[ADDRESS|99 ซอยลาดพร้าว 71 ถนนลาดพร้าว แขวงวังทองหลาง เขตวังทองหลาง กรุงเทพมหานคร 10310]]",
    ),
    (
        "ad03",
        "address_varied",
        "สถานที่ตั้งสำนักงาน [[ADDRESS|เลขที่ 1010 อาคารชินวัตร ถนนพหลโยธิน แขวงจอมพล เขตจตุจักร กทม. 10900]]",
    ),
    ("ad04", "address_varied", "ภูมิลำเนาเดิม [[ADDRESS|บ้านเลขที่ 7 หมู่ที่ 9 ต.แม่เหียะ อ.เมือง จ.เชียงใหม่]]"),
    (
        "ad05",
        "address_varied",
        "โปรดจัดส่งเอกสารมายัง [[ADDRESS|123/456 คอนโดริเวอร์ไซด์ ชั้น 12 ถนนเจริญนคร คลองต้นไทร คลองสาน กรุงเทพฯ]]",
    ),
    (
        "ad06",
        "address_varied",
        "ที่อยู่ปัจจุบัน [[ADDRESS|88 หมู่บ้านสวนหลวง ซอย 4 ตำบลหนองปรือ อำเภอบางละมุง ชลบุรี 20150]]",
    ),
    (
        "ad07",
        "address_varied",
        "สาขาที่ให้บริการ [[ADDRESS|เลขที่ 200 ถนนนิมมานเหมินท์ ตำบลสุเทพ อำเภอเมืองเชียงใหม่ 50200]]",
    ),
    (
        "ad08",
        "address_varied",
        "ส่งใบแจ้งหนี้ไปที่ [[ADDRESS|55/1 ถนนสุขุมวิท ซอย 24 คลองตัน คลองเตย กรุงเทพมหานคร]]",
    ),
    (
        "ad09",
        "address_varied",
        "ที่ทำการไปรษณีย์ปลายทาง [[ADDRESS|หมู่ 5 บ้านโนนสูง ตำบลในเมือง อำเภอเมือง จังหวัดนครราชสีมา 30000]]",
    ),
    (
        "ad10",
        "address_varied",
        "โรงงานตั้งอยู่ที่ [[ADDRESS|นิคมอุตสาหกรรมอมตะนคร 700/1 หมู่ 6 ตำบลดอนหัวฬ่อ อำเภอเมือง ชลบุรี]]",
    ),
    (
        "ad11",
        "address_varied",
        "ที่อยู่จัดส่ง [[ADDRESS|29 ถนนราชดำเนิน ตำบลตลาด อำเภอเมือง จังหวัดนครศรีธรรมราช 80000]]",
    ),
    (
        "ad12",
        "address_varied",
        "สำเนาทะเบียนบ้าน [[ADDRESS|บ้านเลขที่ 312/7 ซอยเพชรเกษม 48 แขวงบางด้วน เขตภาษีเจริญ กทม. 10160]]",
    ),
    (
        "ad13",
        "address_varied",
        "ร้านตั้งอยู่ [[ADDRESS|เลขที่ 15 ตลาดสดเทศบาล ถนนศรีจันทร์ อำเภอเมือง ขอนแก่น]]",
    ),
    (
        "ad14",
        "address_varied",
        "หอพักนักศึกษา [[ADDRESS|9/99 ซอยมหาวิทยาลัย ตำบลคลองหก อำเภอคลองหลวง ปทุมธานี 12120]]",
    ),
    (
        "ad15",
        "address_varied",
        "ที่อยู่เพื่อออกใบกำกับภาษี [[ADDRESS|เลขที่ 456 หมู่ 2 ถนนมิตรภาพ ตำบลปากช่อง อำเภอปากช่อง นครราชสีมา 30130]]",
    ),
    (
        "ad16",
        "address_varied",
        "ส่งของไปบ้าน [[ADDRESS|17 ซอยอ่อนนุช 17 แยก 3 สวนหลวง กรุงเทพฯ 10250]] ฝากไว้หน้าบ้านได้",
    ),
    # ── messy: glued PII, odd spacing, Thai-English labels, multiline ──────
    (
        "ms01",
        "messy",
        "ผู้ติดต่อ[[NAME|มานพ ดีเลิศ]]เบอร์[[PHONE|0891234567]]อีเมล[[EMAIL|manop.d@example.com]]",
    ),
    ("ms02", "messy", "Tel: [[PHONE|0812345678]]   E-mail: [[EMAIL|jane.doe@company.co.th]]"),
    (
        "ms03",
        "messy",
        "ชื่อ [[NAME|กมล ทวีสิน]]\nโทร [[PHONE|0955512340]]\nที่อยู่ [[ADDRESS|12 ถนนสุขุมวิท กทม.]]",
    ),
    ("ms04", "messy", "เลขบัตร[[THAI_ID|8107583270701]]ออกให้ ณ อำเภอเมือง"),
    (
        "ms05",
        "messy",
        "ข้อมูลผู้สมัคร:Name=[[NAME|Somsak Jaidee]],ID=[[THAI_ID|2140527002190]],Tel=[[PHONE|0623456789]]",
    ),
    ...
    (
        "ms10",
        "messy",
        "email :   [[EMAIL|k.watchara@bank.example.com]]   วันเกิด [[DATE_OF_BIRTH|14/02/2535]]",
    ),
    ...
    (
        "ms15",
        "messy",
        "contact person [[NAME|Nattaya S.]] mobile [[PHONE|0644445555]] office 02-555-1234",
    ),
