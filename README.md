...
accuracy phase. AI for Thai group access, the HTTP/Compose participant guide,
and private LLM access have arrived; the deployment project and the exact
public route/auth contract are still pending. No public accuracy claim should
be inferred from the current diagnostic corpus.
